...
.. csharpdocsclass:: ServerSocket.Models.Exceptions.DuplicateLobbyIdException
    :access: 
...
.. csharpdocsconstructor:: DuplicateLobbyIdException()
    :access: public
	
	


.. csharpdocsconstructor:: DuplicateLobbyIdException(System.String message)
    :access: public
    :param(1): 
...
.. csharpdocsconstructor:: DuplicateLobbyIdException(System.String message, System.Exception innerException)
    :access: public
    :param(1): 
    :param(2): 
...
.. csharpdocsconstructor:: DuplicateLobbyIdException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    :access: public
    :param(1): 
    :param(2): 
