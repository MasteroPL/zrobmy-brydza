...
.. csharpdocsclass:: ServerSocket.Models.Exceptions.UsernameTakenException
    :access: public
...
.. csharpdocsconstructor:: UsernameTakenException()
    :access: public
	
	


.. csharpdocsconstructor:: UsernameTakenException(System.String message)
    :access: public
    :param(1): 
...
.. csharpdocsconstructor:: UsernameTakenException(System.String message, System.Exception innerException)
    :access: public
    :param(1): 
    :param(2): 
...
.. csharpdocsconstructor:: UsernameTakenException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    :access: public
    :param(1): 
    :param(2): 
