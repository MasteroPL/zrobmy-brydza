...
.. csharpdocsclass:: EasyHosting.Meta.ConfigurationException
    :access: public
...
.. csharpdocsconstructor:: ConfigurationException()
    :access: public
	
	


.. csharpdocsconstructor:: ConfigurationException(System.String message)
    :access: public
    :param(1): 
...
.. csharpdocsconstructor:: ConfigurationException(System.String message, System.Exception innerException)
    :access: public
    :param(1): 
    :param(2): 
...
.. csharpdocsconstructor:: ConfigurationException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    :access: public
    :param(1): 
    :param(2): 
