...
.. csharpdocsclass:: EasyHosting.Models.Client.ClientNetworkSocketException
    :access: public
...
.. csharpdocsconstructor:: ClientNetworkSocketException()
    :access: public
	
	


.. csharpdocsconstructor:: ClientNetworkSocketException(System.String message)
    :access: public
    :param(1): 
...
.. csharpdocsconstructor:: ClientNetworkSocketException(System.String message, System.Exception innerException)
    :access: public
    :param(1): 
    :param(2): 
...
.. csharpdocsconstructor:: ClientNetworkSocketException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    :access: public
    :param(1): 
    :param(2): 
