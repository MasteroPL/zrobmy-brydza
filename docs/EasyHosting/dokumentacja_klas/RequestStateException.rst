...
.. csharpdocsclass:: EasyHosting.Models.Client.RequestStateException
    :access: public
    :baseclass: EasyHosting.Models.Client.RequestException
...
.. csharpdocsconstructor:: RequestStateException()
    :access: public
	
	


.. csharpdocsconstructor:: RequestStateException(System.String message)
    :access: public
    :param(1): 
...
.. csharpdocsconstructor:: RequestStateException(System.String message, System.Exception innerException)
    :access: public
    :param(1): 
    :param(2): 
...
.. csharpdocsconstructor:: RequestStateException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    :access: public
    :param(1): 
    :param(2): 
