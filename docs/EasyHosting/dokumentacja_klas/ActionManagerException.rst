...
.. csharpdocsclass:: EasyHosting.Models.Actions.ActionManagerException
    :access: public
...
.. csharpdocsconstructor:: ActionManagerException()
    :access: public
	
	


.. csharpdocsconstructor:: ActionManagerException(System.String message)
    :access: public
    :param(1): 
...
.. csharpdocsconstructor:: ActionManagerException(System.String message, System.Exception innerException)
    :access: public
    :param(1): 
    :param(2): 
...
.. csharpdocsconstructor:: ActionManagerException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
    :access: public
    :param(1): 
    :param(2): 
