...
.. csharpdocsclass:: EasyHosting.Models.Server.Serializers.UserAuthorizationSerializer
    :access: public
...
.. csharpdocsconstructor:: UserAuthorizationSerializer()
    :access: public
	
	


.. csharpdocsconstructor:: UserAuthorizationSerializer(Newtonsoft.Json.Linq.JObject data)
    :access: public
    :param(1): 
